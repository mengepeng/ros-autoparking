...
int main(int argc, char **argv)
{
    ...
    SearchParkingSpace searchParkingSpace_lf(&nh_c);  // pass nh_c to class constructor
    ...
    while (ros::ok())
    {
        if (parking_enable)
        {
            ...
            if (!trigger_spinner)
            {
                ...
                sp_spinner->start();
                ROS_INFO("Spinners enabled in seach_parking_space_lf");
            ...
            if (trigger_check)
            {
                ...
                searchParkingSpace_lf.check_parking_space();
            }
        }
        else
        {
            ...
            if (trigger_spinner)
            {
                ...
                sp_spinner->stop();
                ROS_INFO("Spinners disabled in seach_parking_space_lf");
