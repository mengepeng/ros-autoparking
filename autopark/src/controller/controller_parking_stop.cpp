/******************************************************************
 * Filename: controller_parking_stop.cpp
 * Version: v1.0
 * Author: Meng Peng
 * Date: 2020-04-15
...
{
    ros::init(argc, argv, "controller_parking_stop");
    ros::NodeHandle nh;
    ...
    // set message
    msg_parking_enable.data = false;    // to stop autoparking
